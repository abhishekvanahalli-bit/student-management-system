...
urlpatterns = [
    ...
    path('achievements/add/<int:student_pk>/', views.achievement_add, name='achievement_add_for_student'),
    ...
    path('achievements/<int:pk>/status/<str:status>/', views.update_achievement_status, name='achievement_status_update'),
